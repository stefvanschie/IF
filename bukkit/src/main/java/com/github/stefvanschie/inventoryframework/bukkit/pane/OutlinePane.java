 ...
 */
public class OutlinePane extends Pane implements AbstractOutlinePane {
    ...
    public static OutlinePane load(@NotNull Object instance, @NotNull Element element) {
        try {
            ...
            load(outlinePane, instance, element);
            ...
            for (int i = 0; i < childNodes.getLength(); i++) {
                ...
                if (item.getNodeName().equals("empty"))
                    ...
                    outlinePane.addItem(loadItem(instance, (Element) item));
            }
