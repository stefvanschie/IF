...
/**
 * This annotation indicates the method that will be the bottom click handler for the {@link Gui}. The annotation must
 ...
 * method. This handler may be overwritten at a later moment with {@link Gui#setOnBottomClick(Consumer)}. If multiple
...
public @interface BottomClickHandler {}
