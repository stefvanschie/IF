...
import net.minecraft.server.v1_16_R2.MerchantWrapper;
...
public class MerchantInventoryImpl extends MerchantInventory {
    ...
    private abstract static class InventoryViewProvider extends TileEntityContainer {
         ...
         */
        private final NonNullList<net.minecraft.server.v1_16_R2.ItemStack> items = NonNullList.a(3, net.minecraft.server.v1_16_R2.ItemStack.b);
        ...
        public boolean isEmpty() {
            for (net.minecraft.server.v1_16_R2.ItemStack itemStack : this.items) {
        ...
        @Override
        public net.minecraft.server.v1_16_R2.ItemStack getItem(int index) {
            return index >= 0 && index < this.items.size() ? this.items.get(index) : net.minecraft.server.v1_16_R2.ItemStack.b;
        }

        @Override
        public net.minecraft.server.v1_16_R2.ItemStack splitStack(int firstIndex, int secondIndex) {
            net.minecraft.server.v1_16_R2.ItemStack itemstack = ContainerUtil.a(this.items, firstIndex, secondIndex);
        ...
        @Override
        public net.minecraft.server.v1_16_R2.ItemStack splitWithoutUpdate(int index) {
            net.minecraft.server.v1_16_R2.ItemStack itemStack = this.items.get(index);

            if (itemStack.isEmpty()) {
                return net.minecraft.server.v1_16_R2.ItemStack.b;
            }

            this.items.set(index, net.minecraft.server.v1_16_R2.ItemStack.b);

            return itemStack;
        }

        @Override
        public void setItem(int index, net.minecraft.server.v1_16_R2.ItemStack itemStack) {
        ...
        @Override
        public List<net.minecraft.server.v1_16_R2.ItemStack> getContents() {
            return this.items;
        }
    ...
    private static class ContainerMerchantImpl extends ContainerMerchant {
        ...
        public ContainerMerchantImpl(
            ...
            Slot newSlot = new Slot(container, slot.index, slot.e, slot.f) {
                ...
                @Contract(value = "_ -> false", pure = true)
                @Override
                public boolean isAllowed(@Nullable net.minecraft.server.v1_16_R2.ItemStack itemStack) {
                    return false;
                }
            };
