package com.github.stefvanschie.inventoryframework.annotation;
...
/**
 * This annotation indicates the method that will be the close handler for the {@link Gui}. The annotation must be
 * placed on a method declaration. The method must occur in a class which extends a subtype of {@link Gui}; this may not
 * be an enclosing, enclosed, or parent class. The gui will automatically have its close handler set to this method.
 * This handler may be overwritten at a later moment with {@link Gui#setOnClose(Consumer)}. If multiple methods within
 * this class have this annotation, a {@link MultipleAnnotationsException} will be thrown.
 * <p>
 * The referenced method may either have no parameters declared, or one parameter declared which equals or is a
 * supertype of {@link InventoryCloseEvent}. If it has one parameter declared, the argument upon this method being
