...
/**
 * This annotation indicates the method that will be the global drag handler for the {@link Gui}. The annotation must be
 * placed on a method declaration. The method must occur in a class which extends a subtype of {@link Gui}; this may not
 * be an enclosing, enclosed, or parent class. The gui will automatically have its global drag handler set to this
 * method. This handler may be overwritten at a later moment with {@link Gui#setOnGlobalDrag(Consumer)}. If multiple
...
public @interface GlobalDragHandler {}
