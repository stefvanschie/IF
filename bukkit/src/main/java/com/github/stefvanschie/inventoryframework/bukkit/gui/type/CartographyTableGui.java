...
import com.github.stefvanschie.inventoryframework.core.gui.type.AbstractCartographyTableGui;
 ...
 * @since 0.8.0
 */
public class CartographyTableGui extends NamedGui implements AbstractCartographyTableGui {
    ...
    public CartographyTableGui copy() {
        CartographyTableGui gui = new CartographyTableGui(getTitle());
