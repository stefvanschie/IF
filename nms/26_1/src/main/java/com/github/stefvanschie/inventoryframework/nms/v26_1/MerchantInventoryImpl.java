package com.github.stefvanschie.inventoryframework.nms.v26_1;
...
/**
 * Internal merchant inventory for 26.1.
 *
 * @since 0.12.0
 */
public class MerchantInventoryImpl extends MerchantInventory {
    ...
    private ItemCost convertItemStackToItemCost(@NotNull net.minecraft.world.item.ItemStack itemStack) {
        ...
        return new ItemCost(itemStack.typeHolder(), itemStack.getCount(), predicate, itemStack);
    }
     ...
     */
    @Contract(pure = true)
    private int getContainerId(@NotNull Player nmsPlayer) {
