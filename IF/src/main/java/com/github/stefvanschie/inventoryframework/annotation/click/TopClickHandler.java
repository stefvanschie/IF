...
/**
 * This annotation indicates the method that will be the top click handler for the {@link Gui}. The annotation must be
 ...
 * method. This handler may be overwritten at a later moment with {@link Gui#setOnTopClick(Consumer)}. If multiple
...
public @interface TopClickHandler {}
