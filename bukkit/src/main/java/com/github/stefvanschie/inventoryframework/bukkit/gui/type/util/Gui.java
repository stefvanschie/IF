...
import com.github.stefvanschie.inventoryframework.bukkit.HumanEntityCache;
import com.github.stefvanschie.inventoryframework.bukkit.gui.GuiListener;
import com.github.stefvanschie.inventoryframework.bukkit.util.XMLUtil;
import com.github.stefvanschie.inventoryframework.bukkit.gui.type.*;
import com.github.stefvanschie.inventoryframework.bukkit.pane.*;
import com.github.stefvanschie.inventoryframework.bukkit.pane.component.*;
 ...
 */
public abstract class Gui implements AbstractGui, InventoryHolder {

    /**
     * Whether this gui is updating, true if this is the case, false otherwise. This is used to indicate that inventory
     * close events due to updating should be ignored.
     */
     ...
     */
    @NotNull
    private static final Map<String, BiFunction<? super Object, ? super Element, ? extends AbstractGui>> GUI_MAPPINGS
        = new HashMap<>();
    ...
    protected void callCallback(@Nullable Consumer<InventoryClickEvent> callback,
            @NotNull InventoryClickEvent event, @NotNull String callbackName) {
        if (callback == null) {
            return;
        }
        ...
        try {
            ...
            logger.log(Level.SEVERE, "Exception while handling " + callbackName + ", slot=" + event.getSlot(), t);
        }
    }
    ...
    private <T extends InventoryEvent> void callCallback(@Nullable Consumer<T> callback,
        ...
        try {
            ...
            logger.log(Level.SEVERE, "Exception while handling " + callbackName, t);
        }
    }
     ...
     */
    @Nullable
    public static AbstractGui load(@NotNull Object instance, @NotNull InputStream inputStream) {
        try {
    ...
    public static void registerGui(@NotNull String name,
                            @NotNull BiFunction<? super Object,
                                ? super Element,
                                ? extends AbstractGui> biFunction) {
    ...
    public static void registerPane(@NotNull String name,
                                    @NotNull BiFunction<Object, Element, Pane> biFunction) {
