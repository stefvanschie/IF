package com.github.stefvanschie.inventoryframework.core.pane.util;
...
/**
 * A mask that specifies in which positions the items should be placed. Objects of this class are immutable.
 *
 * @since 0.5.16
 */
public class Mask {
