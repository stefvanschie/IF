...
import org.bukkit.craftbukkit.v1_21_R6.inventory.CraftInventoryLoom;
import org.bukkit.craftbukkit.v1_21_R6.inventory.view.CraftLoomView;
...
/**
 * Internal loom inventory for 1.21.9-1.21.10.
 *
 * @since 0.12.1
 */
public class LoomInventoryImpl extends LoomInventory {
    ...
    private static class ContainerLoomImpl extends LoomMenu {
        ...
        public CraftLoomView getBukkitView() {
            ...
            this.bukkitEntity = new CraftLoomView(this.humanEntity, inventory, this);
