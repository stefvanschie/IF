# IF <a href="https://discord.gg/RXmy4HdR4x"><img style="text-align: right;" src="https://img.shields.io/discord/780514939293925407" alt="Discord guild"></a>
...
```Groovy
dependencies {
    compile 'com.github.stefvanschie.inventoryframework:IF:0.8.1'
    // ...
}
```
